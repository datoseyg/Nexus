 ...
 * columnas que ya alimentan quality.fieldbeat_equipment_identification - NUNCA
 ...
 */
export function deriveEquipmentItems({ equipmentInternalIds, equipmentIdentificationStatus, matchedCandidateIds }: DeriveEquipmentItemsInput): FieldbeatEquipmentIdentityItem[] {
  if (equipmentIdentificationStatus === "STRUCTURED_IDENTIFIED") {
  ...
  // vía equipmentIdentificationStatus, nunca vía un item de equipo inventado.
  return [];
}
